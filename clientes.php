...
//CONSULTAR QUANTOS CLIENTES TEM
        ...
        <tbody>
            <?php if ($num_clientes == 0) { ?>
                ...
                while ($cliente = $query_clientes->fetch_assoc()) {
                    ...
                    //ORGANISANDO O TELEFONE
                    //O TELEFONE ESTA FORMATADO EM conexao.php
                    $telefone = "Não informado";
                    if (!empty($cliente['telefone'])) {
                        $telefone = formatar_telefone($cliente['telefone']);
                    }

                    //AJUSTANDO NASCIMENTO
                    //NASCIMENTO ESTA FORMATADO EM conexao.php
                    $nascimento = "Não informada";
                    if (!empty($cliente['nascimento'])) {
                        $nascimento = formatar_data($cliente['nascimento']);
                    }
                    //CONFIGURANDO DATA HORA E MINUTO 
